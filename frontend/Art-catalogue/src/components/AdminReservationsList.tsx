...
import { AdminReservationDTO } from "@/Types/AdminReservation";
...
const AdminReservationsList: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4">
      <h1 className="text-3xl font-bold text-center my-6">Admin Reservations</h1>
          ...
          {reservations.map((reservation, index) => (
            <div key={index} className="bg-white shadow-md rounded-lg p-6">
              <h2 className="text-xl font-semibold mb-4">
                Reservation #{index + 1} - {reservation.userName}
              </h2>
